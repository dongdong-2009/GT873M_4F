...
****************************************************************************/
/*
 * $Id: sdl_ma_cmd.c,v 1.1.2.12.8.14 2011/10/17 06:50:39 panfeng Exp $
 */
...
static const char *pkt_cmd_usage_set[] = 
{
    ...
    "   direction:1-upstream;0-downstream;2-both.",
...
sal_cmd_result_t ma_cmd_stat(int argc, char **argv)
{
    ...
    cs_printf("%-30s: %u\n", "mc_a                      ", __cpu_rx_stats.cnt_mc_a                      );
    cs_printf("%-30s: %u\n", "mc_b                      ", __cpu_rx_stats.cnt_mc_b                      );
    cs_printf("%-30s: %u\n", "mc_c                      ", __cpu_rx_stats.cnt_mc_c                      );
    cs_printf("%-30s: %u\n", "igmp                      ", __cpu_rx_stats.cnt_igmp                      );
    cs_printf("%-30s: %u\n", "arp                       ", __cpu_rx_stats.cnt_arp                       );
    cs_printf("%-30s: %u\n", "oam                       ", __cpu_rx_stats.cnt_oam                       );
    cs_printf("%-30s: %u\n", "mpcp                      ", __cpu_rx_stats.cnt_mpcp                      );
    cs_printf("%-30s: %u\n", "dhcp                      ", __cpu_rx_stats.cnt_dhcp                      );
    cs_printf("%-30s: %u\n", "pppoe_dis                 ", __cpu_rx_stats.cnt_pppoe_dis                 );
    cs_printf("%-30s: %u\n", "pppoe_session             ", __cpu_rx_stats.cnt_pppoe_session             );
    cs_printf("%-30s: %u\n", "hello                     ", __cpu_rx_stats.cnt_hello                     );
    cs_printf("%-30s: %u\n", "ipv6ndp                   ", __cpu_rx_stats.cnt_ipv6ndp                   );
    cs_printf("%-30s: %u\n", "udf0                      ", __cpu_rx_stats.cnt_udf0                      );
    cs_printf("%-30s: %u\n", "udf1                      ", __cpu_rx_stats.cnt_udf1                      );
    cs_printf("%-30s: %u\n", "udf2                      ", __cpu_rx_stats.cnt_udf2                      );
    cs_printf("%-30s: %u\n", "udf3                      ", __cpu_rx_stats.cnt_udf3                      );
    cs_printf("%-30s: %u\n", "swt                       ", __cpu_rx_stats.cnt_swt                       );
...
{   
    ...
    rc = cs_status_2_cmd_rc_map(epon_request_onu_spec_pkt_dst_get(context,0,0,para1,para2,&state));
    if(rc == SAL_CMD_OK)
    {
        cs_printf("----------------------------------------\n");
