 ...
 * sdl_pon_cmd.c
 *
 * $Id: sdl_pon_cmd.c,v 1.1.2.3.2.33.2.3.2.16 2011/10/18 05:54:27 chuang Exp $
 */
...
sal_cmd_result_t pon_cmd_enc_mode(int argc, char **argv)
{
    ...
    sdl_rt = epon_request_onu_enc_mode_set(context, 0, portid, mode);
    return cs_status_2_cmd_rc_map(sdl_rt);       
}
...
#else
    epon_request_onu_enc_mode_get(context, 0, port, &enc);
