...
extern cs_status sdl_ptp_init(void);

extern cs_status ptp_cmd_self_reg(void);
...
extern cs_status sdl_pktctrl_init(void);
...
{
    /* PON */
    1,                              /* laser_polarity                        激光的极性 */
    32,                             /* laser_on_time                       激光开启时间*/
    32,                             /* laser_off_time                       激光关断时间 */
    0,                              /* laser always on                     激光始终打开*/

    /* MPCP */
    50,                             /* gate_timeout                        GATE消息超时时间50ms*/
    0,                              /* N/A (window_fit) */
    0,                              /* N/A (zqt_mode) */
    AAL_MPCP_PENDING_GRANT_4,       /* pending_grant                       MPCP能力*/
    60,                             /* keep silence time                   轮训时间60ms*/
    ...
    0,
    /* MAC FILTER */
    64,                             /* max_mac_oper_entry     				最大64个MAC地址*/
    0xfffef,                        /* max_mac_oper_aging_time      		MAC 的老化时间*/
...
{   
    ...
    domain_table_dn[DOMAIN_ID_MC].cl_entry_start = 0;
    domain_table_dn[DOMAIN_ID_MC].length         = 17;

    domain_table_dn[DOMAIN_ID_VLAN].cl_entry_start      = 18;
    ...
    domain_table_up[DOMAIN_ID_MAC_ETYPE].cl_entry_start              = 42;
    domain_table_up[DOMAIN_ID_MAC_ETYPE].length                      = 1;
    
    domain_table_dn[DOMAIN_ID_MAC_ETYPE].cl_entry_start              = 42;
    domain_table_dn[DOMAIN_ID_MAC_ETYPE].length                      = 1;
