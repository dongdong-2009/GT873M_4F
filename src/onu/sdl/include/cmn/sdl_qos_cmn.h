...
#ifndef _SDL_QOS_CMN_H_
#define _SDL_QOS_CMN_H_
#include "cs_types.h"
...
/****************************************************************************/
/* $rtn_hdr_start  epon_request_onu_traffic_block                        */
/* CATEGORY   : Device                                                      */
/* ACCESS     : Public                                                      */
/* BLOCK      : SDL                                                         */
/* CHIP       : 8030                                                        */
...
/*              o llidport -- llid to identify which                        */
/*              is intended for, -1 for synchronous invoking                */
/*              o direction --          1 for upstream                      */
/*                                     and 0 for downstream                 */
/*              o is_block -- 1- drop the packets to PON/UNI from this port  */
...
/****************************************************************************/
/* $rtn_hdr_start  epon_request_onu_port_traffic_get                        */
/* CATEGORY   : Device                                                      */
/* ACCESS     : Public                                                      */
/* BLOCK      : SDL                                                         */
/* CHIP       : 8030                                                        */
