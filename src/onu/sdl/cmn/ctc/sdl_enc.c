...
cs_sdl_enc_mode_t g_enc_mode = SDL_ENC_MODE_DISABLE;
...
void sdl_enc_int_handler(void)
{
    ...
    //SDL_INF_LOG("ENC Interrupt triggerred!!!\n");
...
)
{
    ...
    switch(mode){
        case SDL_ENC_MODE_DISABLE:{
            cfg.en = 0;
        }
        break;

        case SDL_ENC_MODE_TRIPLE_CHURNING:{
            cfg_msk.s.mode = 1;
            cfg_msk.s.key_gen_mode = 1;
            
            cfg.en = 1;
            cfg.mode = AAL_ENC_ALG_CHURN;
            cfg.key_gen_mode = AAL_ENC_KEY_GEN_MODE_HW;
        }
        break;
        
        case SDL_ENC_MODE_AES32:{            
            cfg_msk.s.mode = 1;
            cfg_msk.s.key_gen_mode = 1;
            
            cfg.en = 1;
            cfg.mode = AAL_ENC_ALG_AES_32;
            cfg.key_gen_mode = AAL_ENC_KEY_GEN_MODE_SW;
        }
        break;

        case SDL_ENC_MODE_AES48:{
            cfg_msk.s.mode = 1;
            cfg_msk.s.key_gen_mode = 1;
            
            cfg.en = 1;
            cfg.mode = AAL_ENC_ALG_AES_48;
            cfg.key_gen_mode = AAL_ENC_KEY_GEN_MODE_SW;
        }
        break;

        default:{
            SDL_MIN_LOG("enc mode is not supported\n");
            return CS_E_PARAM;
        }
    }
...
{    
    ...
    epon_request_onu_enc_mode_set(context, 0, 0, SDL_ENC_MODE_TRIPLE_CHURNING);
