...
unsigned char Gwd_func_dhcp_pkt_handler(cs_pkt_t *pPkt)
{
  ...
  response_dhcp_pkt = (unsigned char*)iros_malloc(IROS_MID_APP,DHCP_MALLOC_RESPONSE_LEN);
