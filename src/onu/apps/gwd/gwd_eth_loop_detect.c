...
#else
#define __VLAN_MAX                      (9*UNI_PORT_MAX)	/*Ò»¸ö¶Ë¿ÚÓÐ8¸ötag vlan¼ÓÉÏÒ»¸öuntag vlan(default vlan)*/
#endif
...
static void reportPortsLpbStatus( cs_uint16 vid, cs_int8 *session )
{
	...
	//ï¿½ï¿½ï¿½Ë¿ï¿½admin×´Ì¬ï¿½Ñ¾ï¿½Ê¹ï¿½Ü£ï¿½ï¿½ï¿½ï¿½ï¿½ï¿½shutdownï¿½ï¿½Ö¾
						...
						while(i < vnum)
							{
				        		...
				        		if(vid != 0)
				        		{
									...
									{
										/*************************************************************************************************
										*·¢ÏÖÓÐ»·Â·¶Ë¿Ú»½ÐÑ£¬ÐèÒª×öÑÓÊ±2S£¬ÓÃÓÚÍ¬²½Èí¼þºÍÓ²¼þ¶Ë¿Ú×´Ì¬
										**************************************************************************************************/
