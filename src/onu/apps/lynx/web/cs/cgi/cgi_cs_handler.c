...
CGI_HTTPD_FVAR_REG(loid,   DB_CTC_LOID_MAX_LEN+1);
CGI_HTTPD_FVAR_REG(password,   DB_CTC_PWD_MAX_LEN+1);
...
CGI_HTTPD_FVAR_REG(name, DB_CTC_MAX_USR_LEN+1);
CGI_HTTPD_FVAR_REG(pwdold, DB_CTC_MAX_PWD_LEN+1);
CGI_HTTPD_FVAR_REG(pwdnew, DB_CTC_MAX_PWD_LEN+1);
