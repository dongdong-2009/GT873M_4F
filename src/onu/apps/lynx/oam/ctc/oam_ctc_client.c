...
cs_uint8 CTC_MAX_ONU_UNI_PORTS = 1;
        ...
        cs_uint32 len)
{
 ...
 #ifdef HAVE_HW_OAM
         if(intf->ctc_OAM_Ext_Status == OAM_CTC_EXT_ONU_SEND_INFO_ACK_RCV){
                 hw_start_disc_report_timer();
         }
 #endif
...
void oam_org_init()
{
    cs_uint8 ctc_ver_list[] = {0x21,0x20,0x13,0x01};
