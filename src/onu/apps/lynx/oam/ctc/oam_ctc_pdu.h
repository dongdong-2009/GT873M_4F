...
#define HW_OAM_APP_VERSION "V1R01B001"
...
#define ZTE_MC_SWITCH_TRANSPARENT               0xa0
#define CTC_MC_SWITCH_TRANSPARENT_ZTE_EXT       0x2
...
#if (!CTC_STATISTIC_64)
typedef struct{
    cs_uint32 dn_drop_events;
    cs_uint32 up_drop_events;
    cs_uint32 dn_octets;
    cs_uint32 up_octets;
    cs_uint32 dn_frames;
    cs_uint32 up_frames;
    cs_uint32 dn_bc_frames;
    cs_uint32 up_bc_frames;
    cs_uint32 dn_mc_frames;
    cs_uint32 up_mc_frames;
    cs_uint32 dn_crc_err_frames;
    cs_uint32 dn_undersize_frames;
    cs_uint32 up_undersize_frames;
    cs_uint32 dn_oversize_frames;
    cs_uint32 up_oversize_frames;
    cs_uint32 dn_fragments;
    cs_uint32 dn_jabbers;
    cs_uint32 dn_collisions;
    cs_uint32 dn_64_octets_frames;
    cs_uint32 dn_65_127_octets_frames;
    cs_uint32 dn_128_255_octets_frames;
    cs_uint32 dn_256_511_octets_frames;
    cs_uint32 dn_512_1023_octets_frames;
    cs_uint32 dn_1024_1518_octets_frames;
    cs_uint32 up_64_octets_frames;
    cs_uint32 up_65_127_octets_frames;
    cs_uint32 up_128_255_octets_frames;
    cs_uint32 up_256_511_octets_frames;
    cs_uint32 up_512_1023_octets_frames;
    cs_uint32 up_1024_1518_octets_frames;
    cs_uint32 dn_discard_frames;
    cs_uint32 up_discard_frames;
    cs_uint32 dn_err_frames;
    cs_uint32 status_change_times;
