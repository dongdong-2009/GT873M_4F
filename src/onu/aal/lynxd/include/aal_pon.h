...
****************************************************************************/
/*
 * $Id: aal_pon.h,v 1.1.2.8.2.6.16.2 2011/09/14 09:20:47 duchen Exp $
 *
...
typedef struct
{
    ...
    cs_uint8                                            preamble_mode;     // This bit control preamble byte number in TBI code in u/s link when TxFEC is 
                                                                           // disabled. It should be set before ONU starts to work.
