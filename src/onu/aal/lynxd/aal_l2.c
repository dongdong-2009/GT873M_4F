...
{   
    ...
    cs_aal_spec_pkt_ctrl_t  sp_ctrl[] = {
       ...
       /*       they will be from CL_RSLT or others                                                         */
        ...
        {27,  0,  0, 0, 6, {2, 0}, 0, 0, 0, 0, 1},   /**< ONU_AAL_PKT_MYMAC  */
    ...
    data1.bf.bc_dpid=AAL_DPID_PON;
    data1.bf.mc_dpid=AAL_DPID_PON;
    data1.bf.uuc_dpid  = AAL_DPID_PON;
    data1.bf.uuc_fwd_cos = 0;
...
#ifdef HAVE_FE
    REG_FIELD_WRITE_NO_MUTEX(GLOBAL_CTRL, mir_enable, 1);
    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_MII0_PORT_CTRL_1, uuc_dpid, 1);
    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_MII0_PORT_CTRL_1, uuc_fwd_cos, 0);
    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_MII0_PORT_CTRL_1, mc_dpid, 1);
    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_MII0_PORT_CTRL_1, mc_fwd_cos, 0);
    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_MII0_PORT_CTRL_1, bc_dpid, 1);
    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_MII0_PORT_CTRL_1, bc_fwd_cos, 0);

    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_L2E_LEARN_CFG_0, ge_sa_max_learn_limit, 48);
    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_L2E_LEARN_CFG_0, pon_sa_max_learn_limit, 16);
    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_L2E_LEARN_CFG_0, mii0_sa_max_learn_limit, 8);

    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_PON_PORT_CTRL_1, uuc_fwd_cos, 0);
    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_PON_PORT_CTRL_1, bc_fwd_cos, 0);
    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_PON_PORT_CTRL_1, mc_fwd_cos, 0);
    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_PON_PORT_CTRL_1, umc_mirror_src_sel, 1);
    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_PON_PORT_CTRL_1, umc_mirror_groupid, AAL_RATE_LIMIT_FLOW_20);
    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_PON_PORT_CTRL_1, umc_mirror_en, 1);
    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_PON_PORT_CTRL_1, uuc_mirror_src_sel, 1);
    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_PON_PORT_CTRL_1, uuc_mirror_groupid, AAL_RATE_LIMIT_FLOW_20);
    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_PON_PORT_CTRL_1, uuc_mirror_en, 1);
    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_PON_PORT_CTRL_2, bc_mirror_src_sel, 1);
    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_PON_PORT_CTRL_2, bc_mirror_groupid, AAL_RATE_LIMIT_FLOW_20);
    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_PON_PORT_CTRL_2, bc_mirror_en, 1);

    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_PON_PORT_CTRL_1, uuc_dpid, 0);
    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_PON_PORT_CTRL_1, bc_dpid, 0);
    REG_FIELD_WRITE_NO_MUTEX(FE_TOP_PON_PORT_CTRL_1, mc_dpid, 0);
#endif
