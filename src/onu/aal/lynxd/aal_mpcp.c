...
****************************************************************************/
/*
 * $Id: aal_mpcp.c,v 1.1.2.15.6.5.2.7.2.5.2.2.2.1.2.8.2.4.2.20.2.8.2.1.2.4 2011/09/26 09:11:32 xyu Exp $
 */
...
cs_status aal_mpcp_wait_grt_empty(void)
{
    cs_boolean empty=0;  
    cs_uint32  retry=0;
    ...
    if(50000 == retry ) {
        AAL_MIN_LOG("__wait_grt_empty timeout\n");
        return CS_E_TIMEOUT;
    }
    return CS_E_OK;
}
...
cs_status mpcp_init(void)
{
    ...
    timer_cfg.timedrift_dereg_en = 1;
    timer_mask.u32 = 0;
    ...
    timer_mask.s.timedrift_dereg_en = 1;
