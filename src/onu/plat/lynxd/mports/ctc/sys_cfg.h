...
cfg_field_t glb_field[] =
{
    ...
    {CFG_ID_ONU_UNI_CFG         , FIELD_TYPE_CHAR    , "External device"                    ,  1     , SCFG_R   , 0 ,         {0},
            /*HELP STRING*/ "0 - Connected with PHY\n1 - Connected with Switch\n2 - No UNI port",0,2},
    {CFG_ID_MDIO_DEVID          , FIELD_TYPE_BUFF    , "MDIO device ID"                     ,  4     , SCFG_R   , 0 ,         {0x30,0x00,0x00,0x00},
            /*HELP STRING*/ "MDIO device ID(eg. 01:02:01:02)",-1,-1},
    ...
    {CFG_ID_GPIO_PIN1           , FIELD_TYPE_STRING  , "GPIO pin-1"                         ,  32    , SCFG_R   , 0 ,         {"OUTPUT.1\0"},
            /*HELP STRING*/ "GPIO pin description",-1,-1},
    {CFG_ID_GPIO_PIN2           , FIELD_TYPE_STRING  , "GPIO pin-2"                         ,  32    , SCFG_R   , 0 ,         {"INPUT\0"},
            /*HELP STRING*/ "GPIO pin description",-1,-1},
    ...
    {CFG_ID_GPIO_PIN9           , FIELD_TYPE_STRING  , "GPIO pin-9"                         ,  32    , SCFG_R   , 0 ,         {"INPUT\0"},
            /*HELP STRING*/ "GPIO pin description",-1,-1},
    {CFG_ID_GPIO_PIN10          , FIELD_TYPE_STRING  , "GPIO pin-10"                        ,  32    , SCFG_R   , 0 ,         {"OUTPUT.1\0"},
            /*HELP STRING*/ "GPIO pin description",-1,-1},
    {CFG_ID_GPIO_PIN11          , FIELD_TYPE_STRING  , "GPIO pin-11"                        ,  32    , SCFG_R   , 0 ,         {"OUTPUT.0\0"},
            /*HELP STRING*/ "GPIO pin description",-1,-1},
    {CFG_ID_GPIO_PIN12          , FIELD_TYPE_STRING  , "GPIO pin-12"                        ,  32    , SCFG_R   , 0 ,         {"LED.UPS.GREEN.OFF.0\0"},
            /*HELP STRING*/ "GPIO pin description",-1,-1},
    {CFG_ID_GPIO_PIN13          , FIELD_TYPE_STRING  , "GPIO pin-13"                        ,  32    , SCFG_R   , 0 ,         {"LED.RUN.GREEN.ON.0\0"},
            /*HELP STRING*/ "GPIO pin description",-1,-1},
    ...
    {CFG_ID_SWITCH_CHIP_ID      , FIELD_TYPE_CHAR    , "switch chip Id"                     ,  1     , SCFG_R   ,  0 ,        {0},
            /*HELP STRING*/ "0 - RTL8305\n1 - RTL8365",0,1},
...
#define ONU_SW_VERSION              "V1R01B005"
...
#define ONU_HW_VERSION              "v1.1"

/* CTC ONU SN variable container */
#define CTC_VENDER_ID_LEN               4
#define CTC_MODEL_ID_LEN                4
#define CTC_ONU_ID_LEN                  6
#define CTC_ONU_SN_LEN                  14
#define CTC_ONU_HW_LEN                  8
#define CTC_ONU_SW_LEN                  16
...
typedef struct{
    cs_uint8  chip_vendor_id[2 + 1];  
    cs_uint8  chip_model[2 + 1 ];    
    cs_uint8  rev;  
    sys_fw_version_t fw_ver;
    cs_int8   date[9]; /*format yy/mm/dd, example 11/01/29 */
} sys_chip_info_t;


typedef struct{
    cs_uint8 onu_vendor_id[CTC_VENDER_ID_LEN +1];
    cs_uint8 onu_model[CTC_MODEL_ID_LEN + 1];
    cs_uint8 onu_id[CTC_ONU_ID_LEN +1];
    cs_uint8 hardware_ver[CTC_ONU_HW_LEN + 1];
    cs_uint8 software_ver[CTC_ONU_SW_LEN +1]; /* = fw version ASCII 6.1.15.6 */
    cs_uint8 ext_onu_model[CTC_ONU_SW_LEN +1]; /* NULL */
}sys_onu_info_t;

extern cs_status cs_plat_chipset_info_get (
    CS_IN       cs_callback_context_t    context,
    CS_IN       cs_dev_id_t                  device,
    CS_IN       cs_llid_t                       llidport,
    CS_OUT    sys_chip_info_t             *pChipset_info);

extern cs_status cs_plat_onu_info_get (
    CS_IN       cs_callback_context_t    context,
    CS_IN       cs_dev_id_t                  device,
    CS_IN       cs_llid_t                       llidport,
