 ...
 * All rights reserved.
 *
 * $Revision: 1.1.2.1.2.25.6.2 $
 * $Date: 2012/04/17 10:35:00 $
 *
...
/* rtk ptp packet header */
typedef struct
{
    rtk_uint32 second;            /* second */
    rtk_uint32 nano_second;       /* nano second */
}__attribute__((packed)) rtk_cpu_ptp_header_t;

#define RTK_CPU_PTP_HEADER_LEN sizeof(rtk_cpu_ptp_header_t)
