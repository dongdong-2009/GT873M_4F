 ...
 *
 * $Id: cs_types.h,v 1.1.4.2.6.1.2.3.16.6.2.3.2.1.2.14 2011/08/31 03:14:24 jli Exp $
 */
...
typedef cs_uint32 				cs_port_id;
typedef cs_uint32 				cs_physical_port_id;
typedef cs_uint16               cs_logical_link_id;
typedef cs_uint16               cs_vlan_id;
...
typedef enum {
    ...
    CS_UNI_PORT_ID5    = 0x05,//add CS_UNI_PORT_ID5 --CS_UNI_PORT_ID24 by zhangjj
    CS_UNI_PORT_ID6    = 0x06,
    CS_UNI_PORT_ID7    = 0x07,
    CS_UNI_PORT_ID8    = 0x08,
    CS_UNI_PORT_ID9    = 0x09,
    CS_UNI_PORT_ID10    = 0x0a,
    CS_UNI_PORT_ID11    = 0x0b,
    CS_UNI_PORT_ID12    = 0x0c,
    CS_UNI_PORT_ID13    = 0x0d,
    CS_UNI_PORT_ID14    = 0x0e,
    CS_UNI_PORT_ID15    = 0x0f,
    CS_UNI_PORT_ID16    = 0x10,
    CS_UNI_PORT_ID17    = 0x11,
    CS_UNI_PORT_ID18    = 0x12,
    CS_UNI_PORT_ID19    = 0x13,
    CS_UNI_PORT_ID20    = 0x14,
    CS_UNI_PORT_ID21    = 0x15,
    CS_UNI_PORT_ID22    = 0x16,
    CS_UNI_PORT_ID23    = 0x17,
    CS_UNI_PORT_ID24    = 0x18,//add end by zhangjj
