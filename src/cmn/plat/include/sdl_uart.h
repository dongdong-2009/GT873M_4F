...
typedef struct{      
    unsigned char           uart_id;      /* UART number 1,2,3,4*/
    unsigned char           data_bits;    /* 7/8  */
    unsigned char           stop_bits;    /* 1/2 */
    unsigned char           flow_control; /* None/XONXOFF/HardWare */
    cs_uart_parity_t        parity;       /* None/Odd/Even */
    cs_uart_duplex_t       duplex;       /* full-duplex or half-duplex*/
    cs_uart_mode_t         mode;         /* Polling or Interrupt */
    cs_uint32                            baud_rate;    /*300/600/1200/2400/4800/9600/19200/38400/57600/115200*/
} uart_config_t;

typedef cs_int32 (*cs_uart_intr_handler_t)(cs_uint8 , void *);
...
/*NOT GENERATE*/
cs_status cs_plat_uart_intr_handler_get(
    CS_IN   cs_callback_context_t       context,
    CS_IN   cs_dev_id_t                 device,
    CS_IN   cs_llid_t                   llidport,
    CS_IN   cs_uint8                    uart_id,
...
/*NOT GENERATE*/
cs_status cs_plat_uart_intr_handler_set(
    CS_IN   cs_callback_context_t       context,
    CS_IN   cs_dev_id_t                 device,
    CS_IN   cs_llid_t                   llidport,
    CS_IN   cs_uint8                    uart_id,
