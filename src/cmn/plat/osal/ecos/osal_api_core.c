...
---------------------------------------------------------------------------------------*/
#if 1
text_uart_id_save uart_save[32];
                              ...
                              cs_uint32 priority, cs_uint32 flags)
{
    ...
    *thread_id = possible_taskid;
	uart_save[possible_taskid].thread_id=possible_taskid; 
	uart_save[possible_taskid].id = osal_thread_table[possible_taskid].id;
...
{
    cs_uint32 possible_qid;
    cs_int8 pri_queue_name[16];
    cs_int8 pri_queue_sem_name[16];
    cs_int32 i;
