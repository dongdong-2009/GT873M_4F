...
/*****************************************************************************/
{
    ...
    {
#ifdef HAVE_ZTE_OAM    
        handle_unreco_oui_oams(intf->port,(cs_uint8*)pdu,len);
#endif
    }
}
...
#ifdef HAVE_PTP
    extern cs_uint8 onu_check_8021as_pdu(oam_pdu_hdr_t *pdu);
    if(onu_check_8021as_pdu(pdu)) {
        return ;
    }
#endif
