...
typedef struct {
        cs_uint64 RxFramesOk;
        cs_uint64 RxUnicasts;
        cs_uint64 RxMulticasts;
        cs_uint64 RxBroadcasts;
        cs_uint64 Rx64Octets;
        cs_uint64 Rx127Octets;
        cs_uint64 Rx255Octets;
        cs_uint64 Rx511Octets;
        cs_uint64 Rx1023Octets;
        cs_uint64 RxMaxOctets;
        cs_uint64 RxJumboOctets;
        cs_uint64 RxUndersize;
        cs_uint64 RxOversize;
        cs_uint64 RxFragments;
        cs_uint64 RxJabber;
        cs_uint64 RxFCSErrors;
        cs_uint64 RxDiscards;
        cs_uint64 RxAlignErrors;
        cs_uint64 RxIntMACErrors;
        cs_uint64 RxPppoes;
        cs_uint64 RxQueueFull;
        cs_uint64 RxPause;
        cs_uint64 RxOctetsOkMsb;
        cs_uint64 RxOctetsOKLsb;
        cs_uint64 RxError;
        cs_uint64 TxFramesOk;
        cs_uint64 TxUnicasts;
        cs_uint64 TxMulticasts;
        cs_uint64 TxBroadcasts;
        cs_uint64 Tx64Octets;
        cs_uint64 Tx127Octets;
        cs_uint64 Tx255Octets;
        cs_uint64 Tx511Octets;
        cs_uint64 Tx1023Octets;
        cs_uint64 TxMaxOctets;
        cs_uint64 TxJumboOctets;
        cs_uint64 TxDeferred;
        cs_uint64 TxTooLongFrames;
        cs_uint64 TxCarrierErrFrames;
        cs_uint64 TxSqeErrFrames;
        cs_uint64 TxSingleCollisions;
        cs_uint64 TxMultipleCollisions;
        cs_uint64 TxExcessiveCollisions;
        cs_uint64 TxLateCollisions;
        cs_uint64 TxMacErrFrames;
        cs_uint64 TxQueueFull;
        cs_uint64 TxPause;
        cs_uint64 TxOctetsOk;
        cs_uint64 TxError;
} __attribute__((packed)) oam_onu_counter_container_struct;

typedef struct {
		cs_uint64 TxDropEvents;
		cs_uint64 RxDropEvents;
		cs_uint64 TxOctetsOk;
		cs_uint64 RxOctetsOKLsb;
		cs_uint64 TxFramesOk;
        cs_uint64 RxFramesOk;
        ...
        cs_uint64 TxMulticasts;
        cs_uint64 RxMulticasts;
        cs_uint64 TxCrcError;
        cs_uint64 RxCrcError;
        cs_uint64 TxUndersize;
        cs_uint64 RxUndersize;
        cs_uint64 TxTooLongFrames;
        cs_uint64 RxOversize;
        cs_uint64 TxFragments;
        cs_uint64 RxFragments;
        cs_uint64 TxJabber;
        cs_uint64 RxJabber;
        cs_uint64 Tx64Octets;
        ...
        cs_uint64 TxMaxOctets;
        cs_uint64 RxMaxOctets;
		cs_uint64 TxDiscards;
		cs_uint64 RxDiscards;
        cs_uint64 TxError;
        cs_uint64 RxError;
        cs_uint64 ChangeTimes;
} __attribute__((packed)) oam_ctc_onu_counter_container_struct;
#endif
