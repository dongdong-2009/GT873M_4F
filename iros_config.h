...
#define PRODUCTS_GT812C_B		5
#define PRODUCTS_GT812C_PSE		6

#if (PRODUCT_CLASS == PRODUCTS_GT812C)
#define RPU_MODULE_POE 			MODULE_NO
#define RPU_MODULE_PSE 			MODULE_NO
#define RPU_MODULE_GW_DHCPR		MODULE_YES
#elif (PRODUCT_CLASS == PRODUCTS_GT812C_PSE)
#define RPU_MODULE_POE 		MODULE_NO
#define RPU_MODULE_PSE 		MODULE_YES
#undef PRODUCT_CLASS	
#define PRODUCT_CLASS		PRODUCTS_GT812C
#elif (PRODUCT_CLASS == PRODUCTS_GT812C_B)
...
#define MPCP_REG_TIME_OUT_SUPPORT	MODULE_YES
